# Inventário e matriz de conservação de dados MyCFC
...
| Planos/sessões/publicações | Prescrição, grupo, autores, variações | Prestação desportiva | Atleta, tutor, treinador em âmbito | Relação + 2 anos propostos; metodologia sem pessoa pode persistir | Apagar prescrições individualizadas; pseudonimizar autoria quando possível | Desporto |
| Resultados de treino/atividade/métricas | Resultado, distância, duração, esforço, métricas | Histórico pedido e planeamento | Atleta/tutor/treinador autorizado | Relação + 12 meses propostos, salvo histórico escolhido | Apagar dados individuais; estatística só anonimizada | Desporto/privacidade |
