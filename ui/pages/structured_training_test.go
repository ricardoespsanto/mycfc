...
func TestStructuredTrainingRendersAdminIntensityProfilesAndPlannedTotals(t *testing.T) {
	...
	html := output.String()
	for _, expected := range []string{"Perfis de intensidade", "Ritmo sustentável", "O limite inferior de R5", "Esforço planeado", "27 min", "revisão 2"} {
