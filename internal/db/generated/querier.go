...
type Querier interface {
	...
	CancelActivitySyncJob(ctx context.Context, arg CancelActivitySyncJobParams) (int64, error)
	...
	CancelStaleActivitySyncJobs(ctx context.Context, arg CancelStaleActivitySyncJobsParams) (int64, error)
	...
	GetActivityConnectionForUserForUpdate(ctx context.Context, arg GetActivityConnectionForUserForUpdateParams) (ActivityConnection, error)
	...
	PruneActivityLoadObservationsBefore(ctx context.Context, arg PruneActivityLoadObservationsBeforeParams) (int64, error)
	...
	StartActivitySyncJob(ctx context.Context, arg StartActivitySyncJobParams) (ActivitySyncJob, error)
	...
	UpsertActivityLoadObservation(ctx context.Context, arg UpsertActivityLoadObservationParams) (ActivityLoadObservation, error)
