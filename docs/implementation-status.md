...
| 03 Dashboards | Not started | Requires generated templ components, frontend bundle and DB-backed view models. |
| 04 Repair workflow | Partial | Object-store adapter and hostile-image validation exist; form and idempotent handler remain. |
| 05 Authentication and consent | Partial | Shared input validation exists; transactions, sessions and forms remain. |
