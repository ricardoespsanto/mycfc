...
| 03 Dashboards | Partial | Membership-programme dashboards provide competitor metrics/training/groups and leisure news/groups; every adult account can manage dependants, and platform administrators can access fleet/repair/maintenance visibility. Public calendar fallbacks remain available where relevant. |
