...
type Querier interface {
	...
	GetPrivacyActivation(ctx context.Context) (PrivacyRequestActivation, error)
	GetPrivacyActivationForUpdate(ctx context.Context) (PrivacyRequestActivation, error)
