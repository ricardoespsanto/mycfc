...
func (q uploadIntentQueriesFake) BeginMediaUploadIntent(context.Context, dbgen.BeginMediaUploadIntentParams) ([]byte, error) {
	return q.payload, q.err
}
func (q uploadIntentQueriesFake) FinalizeMediaUploadIntent(context.Context, dbgen.FinalizeMediaUploadIntentParams) error {
	return q.err
}
func (q uploadIntentQueriesFake) ConfirmMediaUploadPut(context.Context, dbgen.ConfirmMediaUploadPutParams) error {
	return q.err
}
func (q uploadIntentQueriesFake) MarkMediaUploadCleanup(context.Context, dbgen.MarkMediaUploadCleanupParams) error {
	return q.err
}
