...
cloudflare_plan_permissions=$(hmac_for '{"prior_state":{"values":{"root_module":{"resources":[{"address":"data.cloudflare_zones.application","mode":"data","type":"cloudflare_zones","name":"application","values":{"result":[{"id":"zone-id","name":"example.org","permissions":["#zone:read"]}]},"sensitive_values":{"result":[{"permissions":[false]}]}}]}}}}')
cloudflare_apply_permissions=$(hmac_for '{"prior_state":{"values":{"root_module":{"resources":[{"address":"data.cloudflare_zones.application","mode":"data","type":"cloudflare_zones","name":"application","values":{"result":[{"permissions":["#dns_records:edit","#zone:read"],"name":"example.org","id":"zone-id"}]},"sensitive_values":{"result":[{"permissions":[false,false]}]}}]}}}}')
