...
jq -n \
	...
	'{contract:"mycfc/privacy-restore-drill-attestation/v2",result:"SUCCEEDED",observed_at:$observed_at,valid_until:$valid_until,policy_version:"privacy-policy-v1",executor_version:"privacy-erasure-executor/v2",plan_schema_version:"privacy-erasure-plan/v2",image_digest:"sha256:"+("a"*64),schema_migration_digest:("f"*64),contracts:{backup:"mycfc/postgres-backup/v3",ledger_input:"mycfc/privacy-restore-ledger-input/v2",replay_result:"mycfc/privacy-restore-replay-result/v2",replay:"relational-erasure-replay/v1",closure:"restore-tombstone-closure/v4",synthetic_fixture:"mycfc/privacy-restore-synthetic-fixture/v1"},backup:{created_at:"2026-09-01T02:15:00Z",manifest:{ref:"s3://test/manifest?versionId=v1",sha256:("b"*64),checksum_sha256:("b"*64),kms_key_arn:"arn:aws:kms:eu-west-1:123456789012:key/test",size_bytes:128},dump:{ref:"s3://test/dump?versionId=v2",sha256:("c"*64),checksum_sha256:("c"*64),kms_key_arn:"arn:aws:kms:eu-west-1:123456789012:key/test",size_bytes:256}},ledger:{input_source:"LIVE_LEDGER",inventory_sha256:("1"*64),object_count:1},candidate:{result_sha256:("2"*64),object_count:1,imported_count:1,replayed_count:1,already_applied_count:0,non_replayable_v1_count:0,absence_verified_count:1,synthetic_replayed_count:0,closure_v4_count:1,intent_only_count:0,legacy_closure_v2_count:0,erasure_effective_at_verified_count:1,membership_postcondition_contract:"mycfc/membership-history-postcondition/v1",membership_postcondition_sha256:("5"*64),membership_postcondition_verified_count:1,membership_count:1,variation_count:1,failed_count:0},observer:{image_digest:"sha256:9f2364d2e5382f9ec8689d36d09292e6d3e442c55b83304206d6b179e56157c5",replay_count:1,source_already_applied_count:0,synthetic_count:0,verified_run_count:1,expected_checkpoint_count:5,succeeded_checkpoint_count:5,provider_absent_count:1,consent_clock_verified_count:1,closure_v4_count:1,erasure_effective_at_verified_count:1,membership_postcondition_contract:"mycfc/membership-history-postcondition/v1",membership_postcondition_sha256:("5"*64),membership_postcondition_verified_count:1,membership_count:1,variation_count:1,evidence_sha256:("3"*64)},evidence:{ref:"s3://test/evidence?versionId=v3",sha256:("4"*64),checksum_sha256:("4"*64),kms_key_arn:"arn:aws:kms:eu-west-1:123456789012:key/test",size_bytes:512}}' \
