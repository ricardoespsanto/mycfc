...
func TestRouterHealthAndMethodSemantics(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodGet, "/legal/privacidade", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/termos-gerais", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/cookies", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/uso-imagem", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/responsabilidade-menor", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/direitos", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/privacidade-menores", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/termos-gerais/2026-09-06", http.StatusOK, "", ""},
		{http.MethodGet, "/legal/termos-gerais/versao-inexistente", http.StatusNotFound, "", ""},
		{http.MethodPost, "/legal/privacidade", http.StatusMethodNotAllowed, "GET, HEAD", ""},
		...
		{http.MethodGet, "/admin/representacoes", http.StatusSeeOther, "", "/login?next=%2Fadmin%2Frepresentacoes"},
		{http.MethodGet, "/admin/representacoes/00000000-0000-0000-0000-000000000000", http.StatusSeeOther, "", "/login?next=%2Fadmin%2Frepresentacoes%2F00000000-0000-0000-0000-000000000000"},
		{http.MethodPost, "/admin/representacoes/00000000-0000-0000-0000-000000000000", http.StatusSeeOther, "", "/login?next=%2Fadmin%2Frepresentacoes%2F00000000-0000-0000-0000-000000000000"},
