...
#!/bin/sh
printf '%s\n' "$*" >>"$OBSERVER_CALLS"
printf '%s\n' "${OBSERVER_RESULT:-1|0|0|1|5|5|1|1|1|1|mycfc/membership-history-postcondition/v1|bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb|1|1|1|aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa}"
EOF
...
printf '%s\n' "$output" | jq -e '.replay_count==1 and .synthetic_count==0 and .verified_run_count==1 and .expected_checkpoint_count==5 and .succeeded_checkpoint_count==5 and .provider_absent_count==1 and .consent_clock_verified_count==1 and .closure_v4_count==1 and .erasure_effective_at_verified_count==1 and .membership_postcondition_verified_count==1 and .membership_count==1 and .variation_count==1 and (.membership_postcondition_sha256|test("^[0-9a-f]{64}$")) and (.image_digest|test("^sha256:[0-9a-f]{64}$"))' >/dev/null
...
export OBSERVER_RESULT='1|0|1|1|5|5|1|1|1|1|mycfc/membership-history-postcondition/v1|bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb|1|1|1|dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd'
...
export OBSERVER_RESULT='1|0|0|1|5|5|1|1|1|1|mycfc/membership-history-postcondition/v1|bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb|1|1|1|aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
...
export OBSERVER_RESULT='1|0|0|1|5|4|1|1|1|1|mycfc/membership-history-postcondition/v1|bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb|1|1|1|aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
