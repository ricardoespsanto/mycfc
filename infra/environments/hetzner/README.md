...
This stack creates one CX23 in `fsn1` (or `nbg1`) from Ubuntu 24.04 LTS with Hetzner backups enabled. Its firewall permits public TCP ports 80 and 443. Port 22 is created only when `ssh_source_ips` is non-empty.
