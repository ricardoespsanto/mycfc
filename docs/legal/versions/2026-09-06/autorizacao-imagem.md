...
## Escolhas de autorização

Autorizo, de forma gratuita, a captação e utilização digna e contextualizada da minha imagem/voz, ou da pessoa menor que legalmente represento, nas opções que selecionar:
...
A autorização produz efeitos até ser retirada ou até deixar de existir a finalidade, sendo revista quando a pessoa atinge a maioridade ou muda substancialmente a relação com o clube. Pode ser retirada a qualquer momento através do canal indicado em «Exercer direitos», sem afetar a licitude do uso anterior.

Após retirada, o CFC impede novos usos e remove, num prazo razoável, conteúdos sob o seu controlo, salvo conservação estritamente necessária para declaração, exercício ou defesa de direitos ou outra obrigação legal. O CFC não consegue garantir a eliminação de cópias que terceiros tenham realizado licitamente antes da retirada, mas adotará medidas razoáveis e notificará destinatários quando exigido.

## Registo da decisão

O CFC regista a identidade do titular, quem concedeu a autorização, opções, versão do texto, data e prova técnica estritamente necessária. O tratamento está descrito na Política de Privacidade.

**Decisão:** [ ] autorizo apenas as opções assinaladas  [ ] não autorizo qualquer opção
**Titular:** [preenchido pelo sistema]
**Representante, quando aplicável:** [preenchido pelo sistema]
